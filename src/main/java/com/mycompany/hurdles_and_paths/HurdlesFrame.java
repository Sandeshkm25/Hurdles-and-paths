 ...
 */
package com.mycompany.hurdles_and_paths;
 ...
 * @author Dell
 */
public class HurdlesFrame extends javax.swing.JFrame {

    String dog="\\/hurdles_and_paths/images/dog-poster.png";
    String puppy="mycompany/hurdles_and_paths/images/puppy.jpg";
    String footprint="\\/images/footprint.jpg";
    String thorns="\\/images/thorns.webp";
    /**
     * Creates new form HurdlesFrame
     */
    public HurdlesFrame() {
        initComponents();
        
        this.setLocationRelativeTo(null);
        displayImage(dog,start);
    }
    ...
    private void initComponents() {
        ...
        panelStartLayout.setHorizontalGroup(
            ...
            .addGroup(panelStartLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(start, javax.swing.GroupLayout.DEFAULT_SIZE, 88, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HurdlesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HurdlesFrame().setVisible(true);
            }
        });
    }
